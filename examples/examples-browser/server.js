...
app.get('/', (req, res) => res.redirect('/webcam_face_landmark_detection_ted'))
...
app.get('/webcam_face_landmark_detection_ted', (req, res) => res.sendFile(path.join(viewsDir, 'webcamFaceLandmarkDetectionTed.html')))
...
app.get('/bbt_face_landmark_detection_ted', (req, res) => res.sendFile(path.join(viewsDir, 'bbtFaceLandmarkDetectionTed.html')))
